...
typedef enum {
    ...
    REACTION_ERR_BALANCE_SUCESS, REACTION_ERR_BALANCE_ALREADY_BALANCED, REACTION_ERR_BALANCE_CANNOT_BALANCE, REACTION_ERR_BALANCE_CANNOT_BALANCE_MALLOC_FAILED
    } reaction_err_t;
